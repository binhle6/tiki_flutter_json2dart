...
class JsonSerializerGenerator(classOptions: ClassOptions, fileName: String) :
    DartClassGenerator(classOptions, fileName) {
    ...
    override fun classAnnotation(classOptions: ClassOptions): String {
        return "@JsonSerializable(explicitToJson: ${classOptions.isExplicitToJson}, ignoreUnannotated: ${classOptions.isIgnoreUnannotated})"
    }
